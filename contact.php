...
$mail->SMTPAuth = true;
$mail->Username = 'shubhamdev@keryar.com'; // Your Hostinger email address
$mail->Password = 'Shubhavi@1996'; // Your Hostinger email password
$mail->SMTPSecure = 'tls';
$mail->Port = 587;
...
//Recipients
$mail->setFrom('shubhamdev@keryar.com', 'Contact Us');
$mail->addAddress($email, $name);
$mail->addAddress('shubhamdev@keryar.com', 'Contact Us');
                                                                            ...
                                                                            <td align="left" class="link-wrap" style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; font-size: 0px; padding: 0; padding-bottom: 20px; word-break: break-word;">
                                                                               ...
                                                                               Dear <b>' . $name . '</b><br>
                                                                                  ...
                                                                                  <ul>
                                                                                     ...
                                                                                     <li><strong>Address</strong> - ' . $subject . '</li>
